...
const sadtRoutes = require('./routes/sadtRoutes');
...
// Usando as rotas (Sempre DEPOIS de inicializar o app)
...
app.use('/sadt', sadtRoutes); //ativa a rota do SADT que vai ser usado para controle interno
