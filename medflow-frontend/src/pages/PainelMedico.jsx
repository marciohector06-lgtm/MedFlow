  ...
  return (
    <div className="admin-container">
      ...
      <aside className="sidebar">
        <div className="logo-section" style={{ padding: '20px', display: 'flex', justifyContent: 'center', backgroundColor: '#2c3e50', borderBottom: '1px solid #1a252f', color: '#fff' }}>
          <h2 style={{ margin: 0, fontSize: '16px', letterSpacing: '1px' }}>MENU MEDICO</h2>
        </div>
        <nav className="menu-nav" style={{ marginTop: '20px' }}>
          <button className={abaAtiva === 'consultorio' ? 'active' : ''} onClick={() => setAbaAtiva('consultorio')}>Consultorio</button>
          <button className={abaAtiva === 'historico' ? 'active' : ''} onClick={() => setAbaAtiva('historico')}>Historico</button>
        </nav>
      </aside>

      <main className="content" style={{ backgroundColor: '#f1f5f9' }}>
        <header className="content-header" style={{ backgroundColor: '#fff', borderBottom: '1px solid #e2e8f0', margin: '-30px -30px 30px -30px', padding: '20px 30px' }}>
          <h1 style={{ color: '#1e293b', fontSize: '22px' }}>{abaAtiva === 'consultorio' ? 'PAINEL MEDICO' : 'HISTORICO CLINICO'}</h1>
            ...
            {pacienteAtual && (
              <div style={{ display: 'flex', gap: '25px', alignItems: 'flex-start' }}>
                ...
                <div style={{ width: '400px', position: 'sticky', top: '20px' }}>
                  <div style={{ backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', height: '80vh' }}>
                    ...
                    <textarea 
                      ...
                      style={{ flex: 1, width: '100%', padding: '15px', borderRadius: '6px', border: '1px solid #e2e8f0', backgroundColor: '#f8fafc', resize: 'none', fontFamily: 'monospace', fontSize: '13px', lineHeight: '1.6', color: '#334155' }}
...
const input = { width: '100%', padding: '8px 12px', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '13px', color: '#1e293b', outline: 'none', backgroundColor: '#fff' };
...
const modalStyle = { backgroundColor: '#fff', padding: '25px', borderRadius: '8px', width: '600px', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)' };